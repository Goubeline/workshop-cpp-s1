...
{
    std::vector<std::vector<float>> kernel = {{0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012},
                                            ...
                                            {0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012},
                                            {0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012}};
    sil::Image flou = convolution(image, kernel);
    return convolution(flou, kernel);
}